...
class MainFrame(tk.Frame):
    ...
    def initialisation_widgets(self) -> None:
        ...
        self.label_phase_1.grid(row=index_debut_bloc_ligne , column=1)
        self.entry_phase_1.grid(row=index_debut_bloc_ligne , column=2)
        self.label_phase_2.grid(row=index_debut_bloc_ligne , column=3)
        self.entry_phase_2.grid(row=index_debut_bloc_ligne , column=4)
        self.label_phase_3.grid(row=index_debut_bloc_ligne , column=5)
        self.entry_phase_3.grid(row=index_debut_bloc_ligne , column=6)
        self.label_phase_4.grid(row=index_debut_bloc_ligne , column=7)
        self.entry_phase_4.grid(row=index_debut_bloc_ligne , column=8)
        ...
        self.label_ponderation_1.grid(row=index_debut_bloc_ligne + 1, column=1)
        self.entry_ponderation_1.grid(row=index_debut_bloc_ligne + 1, column=2)
        self.label_ponderation_2.grid(row=index_debut_bloc_ligne + 1, column=3)
        self.entry_ponderation_2.grid(row=index_debut_bloc_ligne + 1, column=4)
        self.label_ponderation_3.grid(row=index_debut_bloc_ligne + 1, column=5)
        self.entry_ponderation_3.grid(row=index_debut_bloc_ligne + 1, column=6)
        self.label_ponderation_4.grid(row=index_debut_bloc_ligne + 1, column=7)
        self.entry_ponderation_4.grid(row=index_debut_bloc_ligne + 1, column=8)

        self.label_orientation_cible.grid(row=index_debut_bloc_ligne + 2, column=1)
        self.entry_orientation_cible.grid(row=index_debut_bloc_ligne + 2, column=2)

        self.label_filtres_netbox.grid(row=index_debut_bloc_ligne + 3, column=1)
        self.bouton_radio_sans_filtre.grid(row=index_debut_bloc_ligne + 3, column=2)
        self.bouton_radio_filtre_65_mhz.grid(row=index_debut_bloc_ligne + 3, column=3)

        self.entry_pas_de_phase.grid(row=7, column=0)
        self.label_frequence_rf.grid(row=8, column=0)
        self.entry_frequence_rf.grid(row=9, column=0)
        self.bouton_validation.grid(row=10, column=0)
        self.bouton_generation_signal.grid(row=11, column=0)
        self.bouton_stop_signal.grid(row=12, column=0)
        self.canvas_zone_visible.get_tk_widget().grid(row=13, column=0, columnspan=5)
        self.canvas_secteur_angulaire.get_tk_widget().grid(row=13, column=4, columnspan=5)
        self.canvas_signaux_generes.get_tk_widget().grid(row=13, column=9, columnspan=5)
